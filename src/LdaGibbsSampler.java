...
//    	დათვი1 ნიანგი2 ძაღლი3 კატა4 კატა4 კნუტი5
//    	თემა:
//    	ბროკოლი6 ბადრიჯანი7 ბროკოლი6
//    	თემა:
//    	ბროკოლი ბადრიჯანი ბროკოლი
//    	თემა:
//    	ბროკოლი ბადრიჯანი ბროკოლი
//    	თემა:
//    	ბროკოლი ბადრიჯანი ბროკოლი
...
//    	ბროკოლი ბადრიჯანი ბროკოლი
//    	თემა:
//    	დათვი ნიანგი ძაღლი კატა კატა კნუტი
//    	თემა:
//    	დათვი ნიანგი ძაღლი კატა კატა კნუტი

        // words in documents
        int[][] documents = { {1, 2, 3, 4, 4, 5},
            {0, 6, 0 , 0, 6, 0},
            {0, 6, 0 , 0, 6, 0},
            {0, 6, 0 , 0, 6, 0},
            {1, 2, 3, 4, 4, 5},
